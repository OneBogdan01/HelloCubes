...
#define SCRHEIGHT 1080	// that we will be using a full 1080p screen this isn't related to screen size, just the default res of the screen
...
//*********************************************************************************	
	...
	************************/
	bool Init();
//*****************************************************************************
//this will test for our keyboards for 400 this is reliable, but some BT keyboards are a problem
//*****************************************************************************
